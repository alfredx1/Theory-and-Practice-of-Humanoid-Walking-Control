...
public:
  ...
  void Compliant_control(Eigen::Vector12d& q_des);
...
private:
 ...
 //
  ...
  Eigen::Vector12d pre_d_hat;
  Eigen::Vector12d pre_desired_q_;
  ...
  void InverseKinematics( Eigen::Isometry3d pelv_trajectory_float_, Eigen::Isometry3d lfoot_trajectory_float_, Eigen::Isometry3d rfoot_trajectory_float_, Eigen::Vector12d& q_des);
  //////////////////////////////////////////////////////
  //HW 2 ///////////////////////////////////////////////
  Eigen::VectorXd temp_px; 
  Eigen::VectorXd temp_py;
  void zmp_trajectory(unsigned int current_step_num_, Eigen::VectorXd& temp_px, Eigen::VectorXd& temp_py);
  //HW 3////////////////////////////////////////////////
  Eigen::VectorXd com_px; 
  Eigen::VectorXd com_py;
  void com_trajectory(unsigned int current_step_num_, Eigen::VectorXd& com_px, Eigen::VectorXd& com_py);
  Eigen::VectorXd temp_cx;
  Eigen::VectorXd temp_cy;
  //////////////////////////////////////////////////////
  //HW 4////////////////////////////////////////////////
  void walking_trajectory(unsigned int current_step_num_);
  //hw6//
  Eigen::VectorXd calc_x;
  Eigen::VectorXd calc_y;
  void preview_com_trajectory(unsigned int current_step_num_, Eigen::VectorXd& com_px, Eigen::VectorXd& com_py, Eigen::VectorXd& calc_x, Eigen::VectorXd& calc_y);
  Eigen::Matrix<double,3,1> X_x;
  Eigen::Matrix<double,3,1> X_y;
  //hw7//
  void online_com_trajectory(unsigned int current_step_num_, Eigen::VectorXd& com_px, Eigen::VectorXd& com_py, Eigen::VectorXd& real_com_x, Eigen::VectorXd& real_com_y);
  Eigen::Matrix<double,3,1> X_tilde;
  Eigen::Matrix<double,3,1> Y_tilde;
  Eigen::VectorXd real_com_x;
  Eigen::VectorXd real_com_y;
  Eigen::Vector3d com_pos;
  //hw8//
  void capture_point(unsigned int current_step_num_, Eigen::VectorXd& temp_px, Eigen::VectorXd& temp_py, Eigen::VectorXd& com_px, Eigen::VectorXd& com_py, Eigen::VectorXd& cp_px_eos, Eigen::VectorXd& cp_py_eos, Eigen::VectorXd& cp_px, Eigen::VectorXd& cp_py);
  Eigen::VectorXd cp_px_eos;
  Eigen::VectorXd cp_py_eos;
  Eigen::VectorXd cp_px;
  Eigen::VectorXd cp_py;
  double px,py,ex,ey,cx,cy,prev_cx,prev_cy,prev_ex,prev_ey,Td;
