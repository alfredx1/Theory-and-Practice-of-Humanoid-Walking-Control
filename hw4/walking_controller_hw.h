...
private:
 ...
 //
  ...
  double zc_;
  double gi_;
  double zmp_start_time_; //?õê?ûò ÏΩîÎìú?óê?Ñú?äî start_time, zmp_ref ?ãú?ûë?êò?äî timeÍ∞ôÏùå
  Eigen::Matrix4d k_;
  ...
  //HW 4////////////////////////////////////////////////
  void walking_trajectory(unasigned int current_step_num_);
  
  // HW5 ///
  void DOB( Eigen::Vector12d& current_motor_q_leg_);
}
