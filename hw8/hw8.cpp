  ...
  if((walking_enable_ == true))
  {
    ...
    if(ready_for_compute_flag_ == true)
    {
      ...
      {      
        ...
        alfred_hw8 <<  walking_tick_*0.005 << "," << com_px(walking_tick_-start_time) << "," << com_py(walking_tick_-start_time) << "," << temp_px(walking_tick_-start_time) << "," << temp_py(walking_tick_-start_time) << "," << cp_px(walking_tick_-start_time) << "," << cp_py(walking_tick_-start_time) << "," << cp_px_eos(walking_tick_-start_time) <<"," << cp_py_eos(walking_tick_-start_time) << endl;
        updateNextStepTime();
